    ...
    <div class="container">
        <div class="row" style=" margin-left:250px;">
            <div class="col-lg-6 col-md-6 o">
                <p class=""><a href="?mod=admin-galeri-foto" class="galeri" style="font-size: 16px; font-weight:bold; text-decoration: none; color:black;">GALERI FOTO</a></hp>
            </div>
            <div class="col-lg-6 col-md-6 o">
