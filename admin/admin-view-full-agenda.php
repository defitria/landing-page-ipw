    ...
    <div class="container">
        ...
        <table class="table">
            ...
            ?>
                ...
                <td class=''><?= $tempat ?></td>
                <td class=''><?= $peserta ?></td>
                <td class=''><a href="?mod=agenda&act=hapusagenda&id=<?= $id ?>" name="hapus" class="btn btn-danger btn-sm">HAPUS</a></td>
                </tr>
            <?php
            }
            ?>
        </table>
        <a href="admin-agenda-ipw.php" class="btn btn-primary btn-sm">KEMBALI</a>
    </div>
</section> <br> <br>